...
import 'package:esc_pos_plus/esc_pos_plus.dart';
import 'package:example/print_util.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Future _printReceiveTest() async {
    ...
    final t1 = await PrintUtils().enerateImageFromString(
        'ក្នុងប៉ុន្មានឆ្នាំចុងក្រោយនេះ', TextAlign.left);
    final t2 = await PrintUtils()
